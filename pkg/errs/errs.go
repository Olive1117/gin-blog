...
var (
	...
	ErrLogin                  = New(http.StatusUnauthorized, 10001, "登录失败")
	ErrLoginToken             = New(http.StatusInternalServerError, 10002, "令牌生成失败")
	ErrLoginCheckTokenFail    = New(http.StatusUnauthorized, 10003, "令牌错误")
	ErrLoginCheckTokenTimeout = New(http.StatusUnauthorized, 10004, "令牌已超时")
